...
class CEdit extends Component{
   ...
   onSubmit = (e)=>{
    ...
    axios.post('http://127.0.0.1:8000/api/cedit/'+id,data).then((res)=>{
         ...
         <div className="main-admin">
            <div className="col-md-12">
                <div className="col-auto">
                  <legend className="text-success" style={{color: 'white'}}>Welcome to Customer Question edit form</legend>
